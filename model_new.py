...
class RegressionCNN(nn.Module):
    def __init__(self):
        ...
        self.conv = nn.Sequential(
            nn.Conv2d(3, 16, 5, stride=2), nn.ReLU(),    # output size: (16, 78, 58)
            nn.Conv2d(16, 32, 5, stride=2), nn.ReLU(),   # output size: (32, 37, 27)
            nn.Conv2d(32, 64, 5, stride=2), nn.ReLU()    # output size: (64, 17, 12)
        )
